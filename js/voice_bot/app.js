...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  // api.ai client
  const apiClient = new ApiAi.ApiAiClient({accessToken: '4fa9ff687b3d4b5d919472c087425600'});

  // Initial feedback message.
  addBotItem("Hi! I’m Logi, your logistics assistant. Tap the microphone and start talking to me.");
